        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">                
                            ...
                            <?php  
                                ...
                                if ($categorias->num_rows > 0) {
                                    ...
                                    while ($row = $categorias->fetch_assoc()) {
                                        ...
                                        echo "<li><a href='app/subastas.php?id=".$id_cat."'>".$cat."</a></li>";
                                    }
                                }else{
                    ...
                    <?php
                        ...
                        if (!isset($_SESSION["id_usuario"])) {
                          ...
                          echo"<li class='dropdown'>
                                    ...
                                    <ul class='dropdown-menu'>
                                        <li>
                                            <a href='app/cuenta.php'>Mi Cuenta</a>
                                        </li>
                                        <li>
                                            <a href='app/agregar_producto.php'>Agregar Productos</a>
                                        </li>
                                        <li>
                  ...
                  ?>
                    <li>
                        <a href="app/carrito.php">Carrito(<?php if(isset($contador)){ echo $contador; }else{ echo "0"; } ?>)</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
